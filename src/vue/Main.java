...
public class Main {
    public static void main( String[] args ) {
        ...
        Message m1 = new Message("titre message 1", loremIpsum, new java.sql.Date(System.currentTimeMillis()));
        Message m2 = new Message("titre message 2", loremIpsum, new java.sql.Date(System.currentTimeMillis()));
        Message m3 = new Message("titre message 3", loremIpsum, new java.sql.Date(System.currentTimeMillis()));
